...
func GenerateAllCaptures(moves *MoveList) {
	moves.Count = 0
...
func GeneratePawnCaptures(moves *MoveList) {
	var source, target int
	var bitboard, attacks uint64
...
func GenerateKnightCaptures(moves *MoveList) {
	var source, target, piece int
	var bitboard, attacks uint64
...
func GenerateBishopCaptures(moves *MoveList) {
	var source, target, piece int
	var bitboard, attacks uint64
...
func GenerateRookCaptures(moves *MoveList) {
	var source, target, piece int
	var bitboard, attacks uint64
...
func GenerateQueenCaptures(moves *MoveList) {
	var source, target, piece int
	var bitboard, attacks uint64
...
func GenerateKingCaptures(moves *MoveList) {
	var source, target, piece int
	var bitboard, attacks uint64
