...
var (
	// masking
	FILE_A = uint64(0b0000000100000001000000010000000100000001000000010000000100000001)
	FILE_B = uint64(0b0000001000000010000000100000001000000010000000100000001000000010)
	FILE_G = uint64(0b0100000001000000010000000100000001000000010000000100000001000000)
	FILE_H = uint64(0b1000000010000000100000001000000010000000100000001000000010000000)
